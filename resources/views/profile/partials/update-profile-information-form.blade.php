<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        <div>
            ...
            <x-text-input id="name" class="block mt-1 w-full" type="text" class="mt-1 block w-full" name="name"
        ...
        <div>
            ...
            <x-text-input id="username" class="block mt-1 w-full" type="text" class="mt-1 block w-full" name="username"
                :value="old('username', $user->username)" required autocomplete="username" />
            <x-input-error class="mt-2" :messages="$errors->get('username')" class="mt-2" />
        </div>
